import { Button, CardContent, Card, Grid, makeStyles, Typography } from '@material-ui/core';
    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
                ...
                <Grid container direction="row" justify="flex-end" alignItems="center">
                    <Grid item sm className={classes.heroTextContainer}>
                        <Typography align="center" variant="h2">Bringing West Coast Technology<br />
                            to the Midwest</Typography>
                        <Grid container justify="center" className={classes.btnContainer}>
                            <Grid item>
                                <Button variant="contained" className={classes.estimateBtn} component={Link} to="/estimate" onClick={() => { props.setValue(5) }}>Free Estimate</Button>
                            </Grid>
                            <Grid item>
                                <Button variant="outlined" className={classes.learnBtnHero} component={Link} to="/revolution" onClick={() => { props.setValue(2); }}><span style={{ marginRight: 10 }} >Learn More</span>
                                    <ButtonArrow width={15} height={15} fill={theme.palette.common.blue} /></Button>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item sm className={classes.animation}> <Lottie options={defaultOptions} height={"100%"}
                        width={"100%"} /></Grid>
                </Grid>
            </Grid>
            ...
            <Grid item>{/* ------- The Information Block ---------*/}
                <Grid container style={{ height: "80em" }} className={classes.infoBackground} alignItems="center">
                    <Grid container item
                    ...
                    >
                            ...
                            <Grid container direction="column" style={{ marginBottom: matchesXS ? "10em" : 0 }}>
                                ...
                                <Grid item>
                                    <Button variant="outlined" style={{ color: "white", borderColor: "white" }}
                                        ...
                                        className={classes.learnBtn} onClick={() => { props.setValue(3) }}><span style={{ marginRight: 10 }}>Learn More</span>
                                        <ButtonArrow width={10} height={10} fill={"white"} /></Button>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item sm style={{ marginRight: matchesXS ? 0 : matchesSM ? "2em" : "5em", textAlign: matchesXS ? "center" : "right" }}>
                            <Grid container direction="column">
                                ...
                                <Typography variant="subtitle2">Say hello! <span>👋</span></Typography>
                                <Grid item>
